...
class BuyingReportDonutChart extends Component {
    constructor(props) {
        super(props)
    }
        ...
        const data = [
            {
                key: 1,
                amount: 69,
                categoryName: "Products Purchased",
                svg: { fill: chartBlueColor }
            },
            {
                key: 2,
                amount: 12,
                categoryName: "Products Exchanged",
                svg: { fill: chartGreenColor }
            },
        ]
