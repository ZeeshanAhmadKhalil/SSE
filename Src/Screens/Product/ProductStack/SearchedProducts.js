...
function SearchedProducts(props) {
    ...
    const RenderSearchedProducts = ({ item, index }) => {
    ...
    function RenderEmptyListComponent() {
        return (
            <View style={{ paddingTop: 100, justifyContent: 'center', alignItems: 'center', borderColor: 'red', borderWidth: 0 }}>
                <Text style={{ color: textOffColor, fontSize: 18 }}>No products against this query!</Text>
            </View>
        )
    }
    function RenderListHeaderComponent() {
        return (
            <CustomHeader
                ...
                onBack={() => props.navigation.navigate("Products")}
            />
        )
    }
    useEffect(() => {
    ...
    return (
        <View style={{ flex: 1 }}>
            <FlatList
                ...
                renderItem={RenderSearchedProducts}
